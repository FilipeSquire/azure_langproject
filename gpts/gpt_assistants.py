...
def question_to_machine(question, OPENAI_API_KEY, model='gpt-5'):
    ...
    system_msg = """
        ...
        -ALWAYS state in the beginning of your answer the INFORMATION SOURCE to answer that question. The following SOURCES combinations are possible: annual reporting, annual reporting + web search, websearch. 
